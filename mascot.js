...
<svg class="mochi-sprite" viewBox="0 0 320 280" xmlns="http://www.w3.org/2000/svg">
  ...
  <g class="mochi-body-group">
    ...
    <ellipse class="mochi-eye-open" cx="128" cy="188" rx="10" ry="12.5" fill="#4a3a2c"/>
    <ellipse class="mochi-eye-open" cx="188" cy="188" rx="10" ry="12.5" fill="#4a3a2c"/>
    <path class="mochi-eye-closed" d="M116 189 q12 10 24 0" stroke="#4a3a2c" stroke-width="4" stroke-linecap="round" fill="none"/>
    <path class="mochi-eye-closed" d="M176 189 q12 10 24 0" stroke="#4a3a2c" stroke-width="4" stroke-linecap="round" fill="none"/>
