...
contextBridge.exposeInMainWorld('pet', {
  // toggle click-through when hovering the sprite
  ...
  // fires with 'music' | 'paint' | null whenever what the user is doing changes
  onContext: fn => ipcRenderer.on('context:update', (_e, ctx) => fn(ctx)),
});
